...
function ServerManager:LoadMapNow(setMapName)
	...
	GetBulletPhysicsSystem():SetGravity(anyTags, WVector3(0, 25, 0))
...
function GenerateBotName()
	...
	local lastName = math.modf((SRANDOM() * 1000))
	-- local lastName = math.modf((SRANDOM() * #botLastNames) + 1)
	local genName = botFirstNames[firstName] .. " " .. lastName
